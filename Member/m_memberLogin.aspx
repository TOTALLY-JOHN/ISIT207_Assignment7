<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MemberMasterPage.Master" AutoEventWireup="true" CodeBehind="m_memberLogin.aspx.cs" Inherits="Assignment7.m_memberLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sectionPart" runat="server">
    <div style="margin-left:20%; padding-left:5%; width:500px; height:600px; float:left; background-color:#e9e9e9;"><br />
        ...
        <asp:LoginView ID="LoginView1" runat="server">
            ...
            <AnonymousTemplate>
                <asp:Login ID="Login1" runat="server" CreateUserUrl="m_signUp.aspx" DestinationPageUrl="Member/m_default.aspx" CreateUserText="Sign Up for a new account!" BackColor="#F7F7DE" BorderColor="#CCCC99" Font-Size="10pt" Height="333px" Width="466px">
            ...
            <RoleGroups>
                <asp:RoleGroup Roles="Admin">
                    <ContentTemplate>
                        (<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Member/m_default.aspx">Manage Site</asp:HyperLink> or <asp:LoginStatus ID="LoginStatus2" runat="server" />)
                    </ContentTemplate>
                </asp:RoleGroup>
                <asp:RoleGroup Roles="Member">
                    <ContentTemplate>
                        (<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Member/m_default.aspx">Manage Site</asp:HyperLink> or <asp:LoginStatus ID="LoginStatus3" runat="server" />)
                    </ContentTemplate>
                </asp:RoleGroup>
            </RoleGroups>
        </asp:LoginView>
