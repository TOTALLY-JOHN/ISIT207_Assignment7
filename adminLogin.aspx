<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="Assignment7.adminLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="sectionPart" runat="server">
    <div style="margin-left:20%; padding-left:5%; width:500px; height:600px; float:left; background-color:#e9e9e9;"><br />
        ...
        <asp:LoginView ID="LoginView1" runat="server">
            ...
            <AnonymousTemplate>
                <asp:Login ID="Login1" runat="server" CreateUserUrl="SignUp.aspx" DestinationPageUrl="Admin/a_default.aspx" CreateUserText="Sign Up for a new account!" BackColor="#F7F7DE" BorderColor="#CCCC99" Font-Size="10pt" Height="333px" Width="466px">
